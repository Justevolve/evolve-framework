...
class Ev_CheckboxField extends Ev_Field {
 ...
 * @return array
 */
function ev_register_checkbox_field_type( $types ) {
	$types['checkbox'] = 'Ev_CheckboxField';

	return $types;
}

add_filter( 'ev_field_types', 'ev_register_checkbox_field_type' );